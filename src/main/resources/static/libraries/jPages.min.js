...
(function($, window, document, undefined) {
	...
	Plugin.prototype = {
		...
		writeNav : function() {
			...
			navhtml = "<ul class='pagination text-center'>"
...
//					navhtml += "<span>...</span>";
		...
		updateCurrentPage : function(nav, page) { //Esto lo he añadido para quefuncione con bootrstrap pagination
