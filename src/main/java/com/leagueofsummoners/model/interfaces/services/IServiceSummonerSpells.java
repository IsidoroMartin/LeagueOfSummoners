...
/**
 * Servicio summonerSpells, esta es la capa intermedia entre los controlladores y los
 * objetos DAO.
 */

public interface IServiceSummonerSpells {
    SummonerSpellDTO getSummSpell(Long id);
}
