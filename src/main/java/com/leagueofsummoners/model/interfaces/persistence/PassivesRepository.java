...
/**
 * Este bean obtiene los datos de la entidad ChampionPassives de la base de datos
 */
@org.springframework.stereotype.Repository
public interface PassivesRepository extends Repository<ChampionPassiveDTO, Long> {

	/**
	 * Obtiene todas las pasivas
	 * @return Lista con todas las passivas.
	 */
	List<ChampionPassiveDTO> findAll();

	/**
	 * Obtiene una pasiva por su ID
	 * @param passiveId
	 * @return la passiva con la id parametrizada
	 */
