...
/**
 * Este bean obtiene los datos de la entidad Champions de la base de datos
 */
...
public interface ChampionRepository extends Repository<ChampionDTO, Long> {
	 ...
	 * @param championName
	 * @return El campeón con ese nombre
	 */
	ChampionDTO findBychampionNameIgnoringCase(String championName);

	/**
	 * Busca un campeón por ID
	 * @param idChampion
	 * @return el campeón con la ID
	 */
