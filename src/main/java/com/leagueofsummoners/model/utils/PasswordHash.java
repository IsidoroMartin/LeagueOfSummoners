...
/**
 * Esta clase contiee métodos utiles para encriptar la contraseña
 */
...
/**
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Introduce una password para saber si son iguales");
        String passworduser = new Scanner(System.in).next();

        if (validatePassword(passworduser, passwordDatabase)) {
