...
public class SummonerRestService {
    ...
    /*    if (isUpdating != null && isUpdating ||  session.getAttribute(SessionAtts.SESSION_LATEST_MATCHES) == null) {
            matchs = this.servicesSummoner.getLatestMatchesFromRiot((UserDTO) session.getAttribute(SessionAtts.SESSION_GET_USER_LOGGED), 5);
        ...
        /*this.servicesSummoner.getNextMatches(user,5);*/
